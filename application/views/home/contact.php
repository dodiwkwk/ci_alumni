                            ...
                            <div class="col-12 col-lg-5">
                                <div class="contact-information wow fadeInUp" data-wow-delay="400ms">
                                    ...
                                    <div class="contact-social-info d-flex mb-30">
                                        <a href="<?= base_url(); ?>home/contact"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
                                        <a href="<?= base_url(); ?>home/contact"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                        <a href="<?= base_url(); ?>home/contact"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                        <a href="<?= base_url(); ?>home/contact"><i class="fa fa-dribbble" aria-hidden="true"></i></a>
                                        <a href="<?= base_url(); ?>home/contact"><i class="fa fa-behance" aria-hidden="true"></i></a>
                                        <a href="<?= base_url(); ?>home/contact"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                    </div>
