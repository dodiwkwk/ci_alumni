					...
					<div class="row justify-content-center">
						<div class="col-md-6">
							<form method="post">
								...
								<textarea name="testimoni" id="testimoni" cols="30" rows="10" class="form-control"><?= $testimoni['testimoni']; ?></textarea>
								...
								<select name="is_view" id="is_view" class="form-control">
									<?php foreach($is_view as $result): ?>
										<?php if($result == $testimoni['is_view']): ?>
								...
								<input type="hidden" value="<?= $testimoni['id_testimoni']; ?>" name="id_testimoni">
